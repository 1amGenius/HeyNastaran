...
public interface IUserService
{
    ...
    /// <returns>
    /// The newly created <see cref="Models.User"/> instance.
    /// </returns>
    ...
    /// <param name="cancellationToken">CancelationToken</param>
    /// <returns>
    /// The matching <see cref="Models.User"/> if found; otherwise <c>null</c>.
    /// </returns>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown if the provided Telegram ID is invalid (e.g., non-positive).
    /// </exception>
    public Task<Models.User> GetUserByTelegramIdAsync(long telegramId, CancellationToken cancellationToken = default);
    ...
    /// </exception>
    public Task<Models.User> GetUserByIdAsync(string id, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">CancelationToken</param>
    /// <returns>
    /// The updated <see cref="Models.User"/> if found; otherwise <c>null</c>.
    /// </returns>
    /// <exception cref="ArgumentException">
    /// Thrown if the provided user ID is null, empty, or whitespace.
    /// </exception>
    ...
    /// </exception>
    public Task<Models.User> UpdateUserAsync(string id, UserUpdateDto update, CancellationToken cancellationToken = default);
    ...
    /// </exception>
    public Task<Models.User> UpdateLocationAsync(string id, LocationDto location, CancellationToken cancellationToken = default);
    ...
    /// </exception>
    public Task<Models.User> UpdateTimezoneAsync(string id, string timezone, CancellationToken cancellationToken = default);
    ...
    /// </exception>
    public Task<Models.User> UpdatePreferencesAsync(string id, PreferencesDto prefs, CancellationToken cancellationToken = default);
    ...
    /// </exception>
    public Task<Models.User> AddFavoriteArtistAsync(string id, string artist, CancellationToken cancellationToken = default);
    ...
    /// Thrown if the provided user ID or artist name is null, empty, or whitespace.
    /// </exception>
    public Task<Models.User> RemoveFavoriteArtistAsync(string id, string artist, CancellationToken cancellationToken = default);
    ...
    /// </exception>
    public Task<Models.User> ReplaceFavoriteArtistsAsync(string id, IEnumerable<string> artists, CancellationToken cancellationToken = default);
